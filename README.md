...
Мобильное приложение для доставки ПП еды, разработанное на Swift с полностью оригинальным дизайном, использованием архитектуры MVP и паттерна Coordinator.
